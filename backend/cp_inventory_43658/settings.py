"""
Django settings for cp_inventory_43658 project.
...
ROOT_URLCONF = 'cp_inventory_43658.urls'
...
WSGI_APPLICATION = 'cp_inventory_43658.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cp_inventory_43658 API",
    "DESCRIPTION": "API documentation for cp_inventory_43658 App",
    "VERSION": "v1",
}
